...
namespace pnganalysis {
	 ...
	 */
	unordered_map<RGBAPixel, int> frequency( const PNG & image );
	 ...
	 */
	PNG histogram( const unordered_map<RGBAPixel, int> & frequencies, size_t max_colors );
	 ...
	 */
	vector<RGBAPixel> top_colors( const unordered_map<RGBAPixel, int> & frequencies, size_t limit );
